...
<body>
    ...
    <div class="text-center fw-bold border-bottom border-dark pb-2">REGISTRO DE ENTRADA DE EQUIPAMENTOS PARA MANUTENÇÃO</div>
    ...
    <div class="row mt-4 pt-4">
        ...
        <div class="col-6 mt-4 pt-4">
            ...
            <div class="text-center">Assinatura do Cliente/Entregador</div>
        </div>
