...
<div class="row shadow p-4 border rounded-3 bg-light">
    ...
    <div class="col-md-4 my-2 resumo">
        <a href="{{route('registros.buscar')}}/?status=atrasado" class="text-decoration-none text-dark">
    ...
    <div class="col-md-4 my-2 resumo">
        <a href="{{route('registros.buscar')}}/?status=pendente" class="text-decoration-none text-dark">
            <div class="shadow p-4 bg-warning bg-gradient rounded-3 text-center">
                <strong>Pendentes e Atrasados:</strong>
                <div class="fs-2">{{$reg_count['pendentes']}}</div>
                <div>Totalizando <strong> {{$equip_count['pendentes']}} </strong> equipamento(s).</div>
            </div>
        </a>
    </div>

    <div class="col-md-4 my-2 resumo">
        <a href="{{route('registros.buscar')}}/?status=entregue" class="text-decoration-none text-dark">
            <div class="shadow p-4 bg-success bg-gradient rounded-3 text-center">
