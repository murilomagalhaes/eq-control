<nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm p-3">
    <div class="container-fluid">
        ...
        <a class="navbar-brand display-6 border-end pe-4 text-primary d-flex align-items-center" href="/">
            <svg class="bi me-2" width="26" height="26" fill="currentColor">
                <use xlink:href="{{asset('dist/icons/bootstrap-icons.svg#laptop')}}" />
            </svg>
            <span> EQ  <strong> Control</strong> </span></a>
